...
import googleBookSearchImage from "../img/google-books-save.png";
                ...
                <div className="col-sm">
                    <div className="jumbotron">
                        ...
                        <div className="row">
                            ...
                            <ProjectPanel title="Google Books Search" image={googleBookSearchImage} description="A full stack react app with MongoDB database that retrieved books from Google books webApi, and allowed selected items to be saved to a database" repository="https://github.com/ClaireMDavies/google-book-search" deployed="https://obscure-beach-39028.herokuapp.com//" alt="app image" />
